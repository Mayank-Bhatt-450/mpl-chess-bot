        ...
        for c in range(8):
            ...
            for r in range(8):
                ...
                if ttbl[4]!=True and ttbl[5]and ttbl[6] and cmn and fen_part=='':
                    uth+=1
                    fen_part='n'
                if ttbl[7] and ttbl[8] and ttbl[0]and ttbl[9]!=True and cmn and fen_part=='':
                    uth+=1
                    fen_part='q'
                if(cmn and fen_part==''):
                    print((blk[0]-5,blk[1]),(blk[0]+7,blk[1]),(blk[0]-5,blk[1]+1),(blk[0]+7,blk[1]+1))
                    print(ttbl[10], ttbl[11], ttbl[12], ttbl[13])
