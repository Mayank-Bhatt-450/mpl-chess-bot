...
while True:
    ...
    if tell_color_dis(im.getpixel((899,73)),(10,18,4),30):#or True:
        ...
        for c in range(8):
            ...
            for r in range(8):
                ...
                ptschk=[(blk[0]-7,blk[1]-5),(blk[0]+7,blk[1]-5),(blk[0]+6,blk[1]+2),(blk[0]-6,blk[1]+2),#pawn
                        (blk[0]-9,blk[1]+1),(blk[0]-5,blk[1]+5),(blk[0],blk[1]-15),#knight
        ...
        if tem[0][0]!=tem2[0][0] and 'k' in sufix and tem[0][0]=='r':
            #print('k')
            sufix=sufix.replace('k','')
        if tem[0][7]!=tem2[0][7] and 'q' in sufix and tem[0][7]=='r':
            #print('q')
            sufix=sufix.replace('q','')
            
        if tem[7][0]!=tem[7][0]and 'K' in sufix and tem[7][0]=='R':
            #print('K')
            sufix=sufix.replace('K','')
        if tem[7][7]!=tem[7][7]and 'Q' in sufix and tem[7][7]=='R':
            #print('Q')
            sufix=sufix.replace('Q','')
        alf=['a','b','c','d','e','f','g','h']
