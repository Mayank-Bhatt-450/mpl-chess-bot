...
STOCKFISH_PATH1='C:\\Users\\bhatt\\Desktop\\stockfish-10-win (1)\\stockfish-9-win\\stockfish-9-win\\Windows\\stockfish_9_x64_bmi2.exe'
def extend(s):
    atem1=''
    for iii in s:
...
for i in range(8):
    ...
    for k in range(8):
        if (i+k)%2==0:
            ...
            color='#B58863'
        no+=1
        b2=Label(root,text="",image=w004,width=33,height=4,font=('Verdana', '13'),fg='#ffffff',bg=color)
...
chessEngine2 = Engine(STOCKFISH_PATH1, param={'Threads': 4, 'Ponder': 'true',
                                                    "Syzygy50MoveRule":'false'},depth=14)
