    ...
    if tell_color_dis(im.getpixel((899,73)),(10,18,4),30):#or True:
        ...
        for c in range(8):
            ...
            if spaces!=0:
                ...
                fen+='/'
        tem=past.split('/')
        tem2=fen[:len(fen)-1].split('/')
        if tem[0][4]!=tem[0][4]and sufix!='':
            sufix=sufix.replace('k','').replace('q','')
        if tem[7][4]!=tem[7][4]and sufix!='':
            sufix=sufix.replace('K','').replace('Q','')
        ...
        if tem[1].count('p')==tem2[1].count('p')+tem2[3].count('p'):
            for ig in range(8):
                if tem[1][ig] =='p' and  tem[1][ig]!=tem2[1][ig]:
                    geto=alf[ig]+'6'
        else:
            geto='-'
        

        if tem[1].count('P')==tem2[6].count('P')+tem2[4].count('P'):
            for ig in range(8):
                if tem[7][ig] =='p' and  tem[7][ig]!=tem2[7][ig]:
                    geto=alf[ig]+'6'
        else:
            geto='-'
